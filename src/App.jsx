...
import PopupWithLongText from "./components/PopUp.jsx";
			...
			<AuthProvider>
				<Routes>
					<Route element={<Layout />}>
						...
						<Route
							path="/logout"
							element={<Logout key={nanoid()} />}
						/>
						<Route element={<AuthRequired />}></Route>
						<Route
							path="/"
							element={<Main key={nanoid()} />}
						/>

						<Route
							path="services"
							element={<ServiceLayout key={nanoid} />}
						>
            
            <Route
							path="popUp"
							element={<PopupWithLongText key={nanoid} />}
						/>
						...
						<Route
							path="addUser"
							element={<AddUser key={nanoid()} />}
						/>

						<Route
							path="galleria"
							element={<Upload key={nanoid()} />}
						/>

						<Route
							path="trips"
							element={<TripLayout key={nanoid} />}
						>
							<Route
								index
								element={<ShowTrips key={nanoid()} />}
							/>
							<Route
								path="showTrips"
								element={<ShowTrips key={nanoid()} />}
